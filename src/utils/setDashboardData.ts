...
export const setDashboardData = (customerName: string, customerPhone: string, products: ProductType[], step1Total: number, step2Total: number, step3Total: number, totalSum: number) => {
